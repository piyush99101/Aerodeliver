...
@@ -100,12 +99,11 @@ const TrackPackage: React.FC = () => {
  ...
  const handleSnapshot = useCallback(() => {
    ...
    if (!imgEl) return;
    try {
@@ -127,7 +125,6 @@ const TrackPackage: React.FC = () => {
      ...
      a.href = imgUrl;
@@ -151,7 +148,7 @@ const TrackPackage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (!path) return;
@@ -190,12 +187,8 @@ const TrackPackage: React.FC = () => {
  }
...
@@ -212,7 +205,6 @@ const TrackPackage: React.FC = () => {
    </div>
  );
...
@@ -229,47 +221,33 @@ const TrackPackage: React.FC = () => {
    </div>
  );
...
@@ -279,11 +257,10 @@ const TrackPackage: React.FC = () => {
                <div className="flex-1 min-w-0">
...
@@ -293,71 +270,41 @@ const TrackPackage: React.FC = () => {
      </div>
...
@@ -367,62 +314,27 @@ const TrackPackage: React.FC = () => {
...
@@ -431,152 +343,27 @@ const TrackPackage: React.FC = () => {
          </div>
        </div>
